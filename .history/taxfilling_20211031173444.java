public class taxfilling {
    ...
    Single(String name, int Income, String Status){
        ...
        tax = (Income/100)*tax;
        reutrn System.out.println(name+", the federal income tax for an annual salary of "+Income+" for a "+Status+" filer is "+tax);
    }
    ...
    public static void married(String name, int Income, String Status){
