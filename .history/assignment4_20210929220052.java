...
public class assignment4 {
   ...
   // Boolean counter;
    ...
    double percentageFailed = failedTest/numberofStudents;
    String choice = "yes";
...
for(int x: studentScore){
    ...
    System.out.print("Total of scores entered: " + numberofStudents);
    System.out.print("Total number of students that failed the failed the exam: " + failedTest);
    System.out.print("Percentage of class that failed the exam: " + percentageFailed );
    ...
    failedStudentsNames.get(failedStudents.indexOf(Collections.min(failedStudents)
    }
}
