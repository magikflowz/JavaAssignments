...
public taxFiling(String name, int Income, String Status)
{
    ...
    public String Single(String Name, int Income, String Status){
        ...
        tax = (Income/100)*tax;
        return (name+", the federal income tax for an annual salary of "+Income+" for single status" filer is "+tax);
    }
    ...
    public String married(String name, int Income, String Status){
