...
public taxFiling(String Name, int Income)
{
    ...
    public String headofHousehold(String Name, int Income){
        ...
        tax = (Income/100)*tax;
        System.out.println(0); (Name+", the federal income tax for an annual salary of "+Income+" for a household status filer is "+tax);
    }
