...
# Summary: Shows a food menu and allows users to select items and totals the sum of all items selected
...
public class assignment4_1 {
    ...
    public static void main(String[] args){
        ...
        for (int i=0; i<itemNames.size() && i<itemSelected.size(); i++){
                System.out.println("Item: " + itemNames.get(i)+ "," + " $" + itemSelected.get(i));
